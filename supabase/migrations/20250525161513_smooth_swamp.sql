/*
  ...
  1. Changes
    - Create new storage bucket for POI icons if it doesn't exist
...
DROP POLICY IF EXISTS "POI Icons Public Read Access" ON storage.objects;
...
DROP POLICY IF EXISTS "POI Icons Admin Upload" ON storage.objects;
...
DROP POLICY IF EXISTS "POI Icons Admin Delete" ON storage.objects;
