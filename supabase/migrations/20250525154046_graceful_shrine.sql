/*
  # Update POI type icons with modern symbols
  
  1. Changes
    - Update all POI type icons to use more modern, sleek symbols
    - Maintain existing categories and colors
    - Use consistent icon style across all types
*/
