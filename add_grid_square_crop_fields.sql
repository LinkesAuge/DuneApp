...
ADD COLUMN original_screenshot_url TEXT NULL,
ADD COLUMN crop_x INTEGER NULL,
ADD COLUMN crop_y INTEGER NULL, 
ADD COLUMN crop_width INTEGER NULL,
ADD COLUMN crop_height INTEGER NULL,
ADD COLUMN crop_created_at TIMESTAMP WITH TIME ZONE NULL;
...
-- Update existing records to use screenshot_url as both original and current
UPDATE grid_squares 
